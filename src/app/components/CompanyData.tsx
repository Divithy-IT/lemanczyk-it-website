...
export default function CompanyData() {
  return (
      <main id="main-content" className="bg-white text-gray-900 font-sans">
        <section className="relative z-10 py-14 sm:py-20 lg:py-28">
          <div className="max-w-[1440px] mx-auto px-5 sm:px-6 lg:px-12">
            <div className="max-w-5xl">
              <span className="text-blue-600 uppercase tracking-widest text-sm font-bold font-['Sora',system-ui,sans-serif] flex items-center gap-3">
                <span className="w-8 h-[2px] bg-blue-600"></span> Dane firmy
              </span>
              <h1 className="mt-6 font-['Sora',system-ui,sans-serif] text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight text-gray-900 break-words">
                NIP: 9532817901
              </h1>
              <p className="mt-5 max-w-3xl text-gray-600 text-base sm:text-lg leading-relaxed">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-2 font-['Sora',system-ui,sans-serif] text-xl sm:text-2xl font-semibold text-gray-900 break-words">
                        {value}
                      </p>
                    </div>
                  </div>
